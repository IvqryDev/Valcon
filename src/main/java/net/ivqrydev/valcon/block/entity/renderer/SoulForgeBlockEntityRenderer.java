package net.ivqrydev.valcon.block.entity.renderer;
...
public class SoulForgeBlockEntityRenderer implements BlockEntityRenderer<SoulForgeBlockEntity> {
    public SoulForgeBlockEntityRenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(SoulForgeBlockEntity pBlockEntity, float pPartialTick, PoseStack pPoseStack,

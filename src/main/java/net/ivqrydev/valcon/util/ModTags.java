...
public class ModTags {
    ...
    public static class Items {
        public static final TagKey<Item> GREAT_RUNE_APPLICABLE = createTag("enchantable/great_rune_applicable");

        private static TagKey<Item> createTag(String name) {
            return ItemTags.create(ResourceLocation.fromNamespaceAndPath(Valcon.MOD_ID, name));
        }
    }
}